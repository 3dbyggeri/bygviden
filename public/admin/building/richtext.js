...
function writeRTE(rte, html, width, height, buttons, readOnly) {
	...
	if (buttons == true) {
    /*
		document.writeln('<table style="visibility:hidden" class="rteBack" cellpadding=2 cellspacing=0 id="Buttons1_' + rte + '" width="' + tablewidth + '">');
		document.writeln('	<tr>');
		document.writeln('		<td>');
...
function enableDesignMode(rte, html, readOnly) {
	...
	if (cssFile.length > 0) {
		...
		frameHtml += "	font-size:10px;font-family:verdana,sans-serif;\n";
