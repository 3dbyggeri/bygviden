			...
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
                  ...
                  ?>
									...
									<?else:?>
										<a href="../agents/index.php?id=<?=$nodes[$i]["id"]?>" title="Edit" class="nodeName" onclick="parent.resize('normal');" target="contentfrm" onfocus="if(this.blur)this.blur();"><img src="graphics/doc<?=$iconPostFix?>.gif" alt="Edit" border="0"/></a>
									<?endif?>
								</td>
								<?//==================SPACER CELL============================?>
