...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		 ...
		 <form id="signup" action="<?=$_SERVER['PHP_SELF']; ?>" method="get">
                 ...
                 <p>
                   Nu har du mulighed for at abonnere p&aring; et nyhedsbrev fra bygviden.dk, 
                   s&aring;ledes at du hver m&aring;ned modtager relevante nyheder om byggeteknisk 
                   viden og produktnyheder direkte i din email indbakke. 
                 </p>
		  <fieldset>
