...
[public/bibs/]              vidensleverandøraftale - maybe not used 
                            anymore
...
[public/page/]              Frontend core - Used to showing pages - 
                            maybe not used anymore (pagetema is used 
                            instead)

[public/pagetema/]          Frontend core - Used to showing pages
...
[dev_a_user]                  Contains the users with access to the 
                              administration area. Passwords are stored
                              as MD5 hashes.

[dev_kilde2element]           Relation table linking publications to 
                              building elements and categories.

[dev_kildestyring]            Contains all publications

[dev_*_state]                 Seems to only be used in:
                                admin/util/brancheTree.php
                                admin/util/brancheTreeNew.php
                                admin/util/tree.php