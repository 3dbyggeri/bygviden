class CreateInitialSchema < ActiveRecord::Migration  
  ...
  def self.down
    drop_table 'dev_a_user'
    drop_table 'dev_adnews'
    drop_table 'dev_agent2element'
    drop_table 'dev_agentstyring'
    drop_table 'dev_agentstyring_state'
    drop_table 'dev_banner_advertiser'
    drop_table 'dev_banner_management'
    drop_table 'dev_banner_salesman'
    drop_table 'dev_beton'
    drop_table 'dev_beton_state'
    drop_table 'dev_blog'
    drop_table 'dev_branche2category'
    drop_table 'dev_branche_relevans'
    drop_table 'dev_branche_tree'
    drop_table 'dev_brancher'
    drop_table 'dev_bruger'
    drop_table 'dev_bruger_rabat'
    drop_table 'dev_buildingelements'
    drop_table 'dev_buildingelements_state'
    drop_table 'dev_bygcatpubbranch'
    drop_table 'dev_categori'
    drop_table 'dev_categori2element'
    drop_table 'dev_general'
    drop_table 'dev_general_state'
    drop_table 'dev_houses'
    drop_table 'dev_kilde2element'
    drop_table 'dev_kildestyring'
    drop_table 'dev_kildestyring_state'
    drop_table 'dev_kloak'
    drop_table 'dev_kloak_state'
    drop_table 'dev_maling'
    drop_table 'dev_maling_state'
    drop_table 'dev_mur'
    drop_table 'dev_mur_state'
    drop_table 'dev_newsletter'
    drop_table 'dev_newsletter2paragraph'
    drop_table 'dev_newsletterparagraph'
    drop_table 'dev_paragraph'
    drop_table 'dev_producent'
    drop_table 'dev_producer'
    drop_table 'dev_product'
    drop_table 'dev_product2element'
    drop_table 'dev_product2varegruppe'
    drop_table 'dev_product_category'
    drop_table 'dev_product_links'
    drop_table 'dev_products'
    drop_table 'dev_produkt2element'
    drop_table 'dev_realms'
    drop_table 'dev_role'
    drop_table 'dev_roles_constrains'
    drop_table 'dev_search_branche_stats'
    drop_table 'dev_search_category_stats'
    drop_table 'dev_search_stats'
    drop_table 'dev_stats'
    drop_table 'dev_subscriber'
    drop_table 'dev_tema'
    drop_table 'dev_tema_bygning'
    drop_table 'dev_tema_editor'
    drop_table 'dev_tema_kilde'
    drop_table 'dev_tema_page'
    drop_table 'dev_trae'
    drop_table 'dev_trae_state'
    drop_table 'dev_usage'
    drop_table 'dev_user2role'
    drop_table 'dev_varegruppe2element'
    drop_table 'dev_varegrupper'
    drop_table 'dev_varegrupper_state'
  end
end